...
public class ClosedRestAdapter extends RecyclerView.Adapter<ClosedRestAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.cuisineListText.setText(closeResturantObjects.get(position).getCousineList());
        ...
        holder.distanceText.setText(String.valueOf(closeResturantObjects.get(position).getDistance()).substring(0, 3)+" miles");
        holder.ratingBar.setRating(Float.parseFloat(closeResturantObjects.get(position).getAggregateFeedback()));
