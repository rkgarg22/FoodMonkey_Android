...
import com.app.foodMonkey.ApiObject.HomeViewedObject;
...
//            holder.seeMore.setText("£ " +viewedObjects.get(position).getMinSpend());//"$5.00");
            ...
            holder.ratingBar.setRating(Float.parseFloat(viewedObjects.get(position).getAggregateFeedback()) + 1);
        } else {
            holder.title.setText(viewedObjects.get(position).getRestName());
            ...
            if (!viewedObjects
                    .get(position).getAggregateFeedback().equals("0.00"))
                holder.ratingBar.setRating(Float.parseFloat(viewedObjects.get(position).getAggregateFeedback()) + 1);
